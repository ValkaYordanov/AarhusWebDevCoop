...
namespace AarhusWebDevCoop.Controllers
{
    public class ProjectsOverviewController : Umbraco.Web.Mvc.RenderMvcController
    {
        ...
        public override  ActionResult Index(ContentModel model)
        {
            ...
            string projectStatus = "completed"; viewModel.ProjectStatus = projectStatus;
            ...
            projects = projects.Where(x => x.GetProperty("projectStatus").GetValue().ToString().ToLower() == projectStatus);
